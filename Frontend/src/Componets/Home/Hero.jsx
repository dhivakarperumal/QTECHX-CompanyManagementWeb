...
const Hero = () => {
  ...
  return (
    <section className="relative mt-[72px] w-full overflow-hidden bg-[#03070a]">
      ...
      {/* Top border */}
      <div className="absolute left-0 right-0 top-0 h-px bg-[#FF6A00]/20" />

      {/* ================= CONTENT ================= */}

      <PageContainer className="relative z-10">

        <div className="grid min-h-[590px] items-center gap-4 py-12 sm:py-16 lg:min-h-[620px] lg:grid-cols-[0.95fr_1.05fr] lg:gap-0 lg:py-10">
