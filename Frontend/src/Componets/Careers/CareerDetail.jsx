      ...
      <div className="relative w-full overflow-hidden bg-[#03070a] text-white">
        ...
        <PageContainer className="relative z-10 py-12 sm:py-16 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              APPLY FOR <span className="text-[#FF6A00]">A JOB</span>
            </h2>
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="200"
              className="mx-auto mt-4 text-justify text-xs leading-relaxed text-white/70 sm:text-sm sm:text-center md:text-base"
            >
              Creating a friendly, independent and remote culture is essential to our work
              and we are always looking for the best professionals. You may need to
              complete an application form. Be sure you are applicable for Essential
              Eligibility & Skills needed by the company when submitting your profile.
            </p>
          </div>
          ...
          <div
            ...
            "
          >
            <div className="h-[2px] w-full bg-gradient-to-r from-transparent via-[#FF6A00] to-transparent" />

            <div className="flex flex-col md:flex-row">
              {/* Left Side - Image */}
              <div className="relative w-full overflow-hidden bg-[#080d11] md:w-1/2">
                <img
                  src="/images/careerdetail.jpg"
                  alt="Career Apply"
                  className="h-full min-h-[350px] w-full object-cover md:min-h-[500px]"
                />
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#0d1216] via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-[#11171c]" />
              </div>
              ...
              <div className="w-full p-6 sm:p-8 md:w-1/2 lg:p-10">
                ...
                >
                  ...
                  <div className="relative">
                    <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-white/70">
                      Mobile <span className="text-[#FF6A00]">*</span>
                    </label>
                    <input
                      name="mobile"
                      value={form.mobile}
                  ...
                  <div className="relative">
                    <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-white/70">
                      Location <span className="text-[#FF6A00]">*</span>
                    </label>
                    <input
                      name="location"
                      value={form.location}
                  ...
                  <div className="relative md:col-span-2">
                    <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-white/70">
                      Position You Are Applying For <span className="text-[#FF6A00]">*</span>
                    </label>
                    <select
                      name="position"
                      value={form.position}
                      ...
                      className={`
                        ...
                        rounded-xl
                        border
                        ${errors.position ? "border-red-500" : "border-white/15"}
                        bg-[#080d11]
                        px-4
                        py-3
                        text-sm
                      ...
                      `}
                    >
                      <option value="" className="bg-[#11171c] text-white/70">
                        Select a position
                      </option>
                      {jobs.map((job, i) => (
                        <option
                          key={job.id ?? i}
                          value={job.title}
                          className="bg-[#11171c] text-white"
                        >
                  ...
                  <div className="relative md:col-span-2">
                    <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-white/70">
                      Message / Cover Note <span className="text-[#FF6A00]">*</span>
                    </label>
                    <textarea
                      name="message"
                      value={form.message}
                      onChange={handleChange}
                      rows="4"
                      placeholder="Describe your background and why you'd be a great fit..."
                      className={`
                        w-full
                        rounded-xl
                        border
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md">
              <div className="relative w-full max-w-sm overflow-hidden rounded-2xl border border-white/15 bg-gradient-to-br from-[#1b2228] to-[#0f1418] p-6 text-center shadow-[0_25px_60px_rgba(0,0,0,0.9),0_0_40px_rgba(255,106,0,0.25)] sm:p-8">
                ...
                <p className="mb-6 text-xs leading-relaxed text-white/70 sm:text-sm">
                  Thank you for applying. Our talent acquisition team will review your application and contact you soon.
                </p>
