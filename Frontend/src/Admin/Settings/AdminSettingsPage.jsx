...
import { Settings, CalendarDays, Save, Plus, Loader2, ShieldCheck, ArrowRight } from 'lucide-react';
import api from '../../api';
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/40">Manage leave limits and company-wide leave settings.</p>
            </div>
          </div>
          <button
            onClick={handleSave}
