  ...
  return (
    <div className="quotation-preview min-h-screen pb-16 text-white">
      <div className="mx-auto max-w-7xl space-y-5">
        ...
        <section className="grid gap-4 rounded-2xl border border-orange-500/25 bg-orange-500/[0.06] p-5 sm:grid-cols-3 print:border-gray-300 print:bg-white">
          <div className="rounded-xl border border-white/10 bg-white/[0.04] p-4 print:border-gray-200 print:bg-white">
            <p className="text-[10px] font-bold uppercase tracking-wider text-white/45 print:text-gray-500">Total amount</p>
            <p className="mt-2 text-2xl font-bold text-orange-300 print:text-gray-900">{money(quotation.grand_total, quotation.currency)}</p>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/[0.04] p-4 print:border-gray-200 print:bg-white">
            <p className="text-[10px] font-bold uppercase tracking-wider text-white/45 print:text-gray-500">Advance paid</p>
            <p className="mt-2 text-2xl font-bold text-emerald-300 print:text-gray-900">{money(quotation.advance_amount, quotation.currency)}</p>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/[0.04] p-4 print:border-gray-200 print:bg-white">
            <p className="text-[10px] font-bold uppercase tracking-wider text-white/45 print:text-gray-500">Remaining amount</p>
            <p className="mt-2 text-2xl font-bold text-rose-300 print:text-gray-900">{money(quotation.balance_amount ?? Math.max(Number(quotation.grand_total || 0) - Number(quotation.advance_amount || 0), 0), quotation.currency)}</p>
          </div>
        </section>
