...
const EmployeeView = () => {
  ...
  const renderFileLink = (label, url) => (
    <div className="mb-4 flex flex-col">
      <h4 className="text-xs font-semibold uppercase text-gray-500">{label}</h4>
      {url ? (
        <a href={`http://localhost:5000${url}`} target="_blank" rel="noreferrer" className="mt-1 font-medium text-primary hover:underline">
          View Document
        </a>
      ) : (
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className={`px-3 py-1 rounded-full text-sm font-medium ${employee.employment_status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm text-center">
            <div className="mx-auto h-32 w-32 overflow-hidden rounded-full border-4 border-gray-50 mb-4 bg-gray-100 flex items-center justify-center">
            ...
            <p className="text-sm text-gray-500 mb-2">{employee.designation || 'No Designation'}</p>
            <p className="text-xs font-medium text-gray-400 bg-gray-100 inline-block px-2 py-1 rounded">
              {employee.employee_code || employee.employee_id.substring(0, 8)}
            </p>
          </div>

          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <h3 className="font-semibold text-gray-800 mb-4 border-b pb-2">Quick Contact</h3>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-4 border-b pb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-800">Employment & Emergency</h3>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-y-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-2 mb-4 border-b pb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-800">Banking & Salary</h3>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-y-4">
